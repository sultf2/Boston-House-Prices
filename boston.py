# -*- coding: utf-8 -*-
"""
Created on Wed Jan 20 14:10:10 2016
...
def explore_city_data(city_data):
    ...
    # Number of features?
    print "Number of feature: " ,np.size(housing_features)
...
def split_data(city_data):
    ...
    # set random_state to None to shuffle the dat 
...
def performance_metric(label, prediction):
    ...
    # mean absolute error
    abs_error = metrics.mean_absolute_error(label, prediction)
    
    # mean squared error
    sq_error = metrics.mean_squared_error(label, prediction)
